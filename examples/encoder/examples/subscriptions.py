...
encoder.on(
    RotaryEncoderEvent.HELD,
    lambda: print("Release the button to remove all click listeners"),
)
...
print(
    f"Connect you rotary encoder to the next GPIO pins: CLK {ENCODER_CLK_PIN}, DT {ENCODER_DT_PIN} and SW {ENCODER_SW_PIN}"
)
